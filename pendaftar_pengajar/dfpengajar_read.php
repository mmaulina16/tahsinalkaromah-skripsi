<div class="container-fluid">
    <div class="card">
        <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Data Pendaftaran Pengajar</h5>
            <a href="?page=dfpengajar_add" class="btn btn-success btn-sm"><i class="ti ti-plus"></i>Tambah Data</a>
            <a href="?page=dfpengajar_report" class="btn btn-primary btn-sm"><i class="ti ti-report"></i> Laporan</a>
            <hr>
            <!-- Form Pencarian -->
            <form method="GET" action="index.php">
                <div class="input-group mb-3">
                    <input type="hidden" name="page" value="dfpengajar_read">
            ...
            <div class="table-responsive">
                <table class="table table-hover table-bordered" style="min-width: 2500px;">
                    ...
                    <tbody>
                        ...
                        $query = "SELECT * FROM pengajar WHERE 1=1";
                        if ($search) {
                                ...
                                <?php if ($_SESSION['status'] == 'Admin') { ?>
                                    ...
                                    <td>
                                        <?php if ($row['status_ajuan'] == 'Diajukan') { ?>
                                            <a href="?page=verifikasi_ajuan_pengajar&id_pengajar=<?= $row[0] ?> &status_ajuan=Diverifikasi" class="btn btn-success btn-sm" onclick="return confirm('Yakin ingin menyetujui ajuan ini?')"><i class="ti ti-check"></i>Setujui</a>
                                            <a href="?page=verifikasi_ajuan_pengajar&id_pengajar=<?= $row[0] ?> &status_ajuan=Ditolak" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menolak ajuan ini?')"><i class="ti ti-x"></i>Tolak</a>
                                        <?php } ?>
                                    </td>
                                <?php } ?>
                            </tr>
