...
$query = "SELECT id_anggota, npm, nama_anggota, jenis_kelamin, tanggal_lahir, no_telp, email, alamat, universitas, prodi, batas_belajar, kemampuan, kelas_tahsin, alasan, tanggal_pendaftaran FROM anggota WHERE 1=1";
...
$url_cetak = "pendaftar_anggota/dfanggota_print.php?filter_jk=" . urlencode($filter_jk) . "&filter_kls=" . urlencode($filter_kls) . "&filter_bln=" . urlencode($filter_bln);;
?>
<div class="container-fluid">
	<div class="card">
		<div class="card-body">
			<h5 class="card-title fw-semibold mb-4">Cetak Pendaftaran Anggota</h5>
						...
						if ($sql) {
							...
							if ($row > 0) { // Jika jumlah data lebih dari 0 (Berarti jika data ada)
								while ($data = mysqli_fetch_array($sql)) { // Ambil semua data dari hasil eksekusi $sql
									...
									echo "<td>" . $data['batas_belajar'] . "</td>";
									echo "<td>" . $data['kemampuan'] . "</td>";
								...
								echo "<tr><td colspan='13'>Data tidak ada</td></tr>"; // kolom
							}
						} else {
