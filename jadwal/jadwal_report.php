...
$url_cetak = "jadwal/jadwal_print.php?filter_kls=" . urlencode($filter_kls) . "&filter_bln=" . urlencode($filter_bln);;
?>
<div class="container-fluid">
	<div class="card">
		<div class="card-body">
			<h5 class="card-title fw-semibold mb-4">Cetak Jadwal Tahsin dan Tahfidz</h5>
