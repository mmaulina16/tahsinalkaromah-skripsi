...
if ($filter_bln != '') {
	$query .= " AND MONTH(jadwal_tahsin) = '" . mysqli_real_escape_string($koneksi, $filter_bln) . "'";
}

$url_cetak = "tahsin/tahsin_print.php?&filter_kls=" . urlencode($filter_kls) . "&filter_bln=" . urlencode($filter_bln);;
?>
<div class="container-fluid">
	<div class="card">
		<div class="card-body">
			<h5 class="card-title fw-semibold mb-4">Cetak Data Halaqoh Tahsin</h5>
				...
				<table class="table table-hover table-bordered" style="min-width: 1800px;">
					<thead>
						<tr>
							...
							<th class="text-center">Batas Tahsin</th>
